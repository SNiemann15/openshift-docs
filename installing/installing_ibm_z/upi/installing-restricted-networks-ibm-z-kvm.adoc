...
include::modules/prereqs-ibm-z-kvm-upi-disconnected.adoc[leveloffset=+1]
...
[id="additional-resources_install-init_{context}"]
...
[role="_additional-resources"]
[id="additional-resources_secure-execution_{context}"]
== Additional resources
...
[role="_additional-resources"]
[id="additional-resources_nbde_{context}"]
== Additional resources
...
[role="_additional-resources"]
[id="additional-resources_static-network_{context}"]
== Additional resources
