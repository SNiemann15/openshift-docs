...
[role="_additional-resources"]
.Additional resources
link:https://www.ibm.com/docs/en/linux-on-systems?topic=commands-chzdevl[chzdev - Configure IBM Z devices] in {ibm-name} Documentation.

link:https://www.ibm.com/docs/en/linux-on-systems?topic=linuxonibm/com.ibm.linux.z.ludd/ludd_c_perscfg.html[Persistent device configuration] in {ibm-name} Documentation.
